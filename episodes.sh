...
<opml version="2.0">
	<head>
		<title>դրուագներ</title>
		<dateCreated>Sun, 25 Dec 2022 23:32:45 GMT</dateCreated>
		<ownerEmail>antranig@vartanian.am</ownerEmail>
		<additionalHead>&lt;link rel=&quot;alternate&quot; type=&quot;application/rss+xml&quot; title=&quot;Podcast RSS feed&quot; href=&quot;/ցանցառներ_ռադիօ.xml&quot; /&gt;</additionalHead>
	...
	<body>
		...
		<outline text="դրուագներ" created="Sun, 25 Dec 2022 23:35:18 GMT">
EOF
...
do
  ...
  cat <<EOF
<outline text="${_type} #${_num} – ${_title}" type="link" url="https://ռադիօ.ցանցառներ.հայ/դրուագ/${_type}-${_num}.html"/>"
EOF
done
